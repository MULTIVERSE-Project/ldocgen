...
--- Loads all files in folder recursively. @{LoadFile} If the realm is not specified, it will try to guess it based on the file name. See `mvp.loader.LoadFile` for more info about file naming.
-- @realm shared
